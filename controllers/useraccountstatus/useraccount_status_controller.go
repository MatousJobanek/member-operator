...
func (r *Reconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	mur, err := r.updateMasterUserRecord(logger, request.Name, syncIndex)
	if err != nil {
		if mur != nil {
...
func (r *Reconciler) updateMasterUserRecord(logger logr.Logger, name, syncIndex string) (*toolchainv1alpha1.MasterUserRecord, error) {
